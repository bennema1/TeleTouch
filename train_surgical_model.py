...
def main():
    ...
    # Use simple dataset for basic training
    from data.simple_dataset import SimpleTrajectoryDataset
    from torch.utils.data import DataLoader

    # Load datasets
    train_dataset = SimpleTrajectoryDataset(
        'data/processed/train_inputs.npy',
        'data/processed/train_targets.npy'
    )
    test_dataset = SimpleTrajectoryDataset(
        'data/processed/test_inputs.npy',
    ...
    print(f"Equivalent pixel error: {pixel_mae:.1f}px (on 1920px display)")
